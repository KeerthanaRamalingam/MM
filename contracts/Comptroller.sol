...
contract Comptroller is Initializable {
    ...
    function createEstate(address _landAddress, uint256[] memory landId, string memory tokenIPFSPath) public {
        registry.canCreateEstate(_landAddress, landId, msg.sender);
