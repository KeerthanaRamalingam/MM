...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, Initializable {
     ...
     */
    function ERC721_init(string memory name_, string memory symbol_)
        public
        initializer
    {
        _name = name_;
...
contract ERC721Mint is ERC721 {
     ...
     */
    function _initializeERC721Mint(address _comptroller) internal initializer {
...
// File: contracts/Megaverse/LandNFT.sol

pragma solidity ^0.8.0;

contract LandNFT is ERC721Mint {
    function initialize(
        string memory _name,
        string memory _symbol,
        address _comptroller
    ) public initializer {
        ERC721.ERC721_init(_name, _symbol);
        ERC721Mint._initializeERC721Mint(_comptroller);
    }
}
